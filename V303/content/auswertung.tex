...
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/0.BMP}
    \caption{$\phi = 0^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/45.BMP}
    \caption{$\phi = 45^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/90.BMP}
    \caption{$\phi = 90^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/180.BMP}
    \caption{$\phi = 180^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/270.BMP}
...
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/0_noise.BMP}
    \caption{$\phi = 0^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/45_noise.BMP}
    \caption{$\phi = 45^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/90_noise.BMP}
    \caption{$\phi = 90^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/180_noise.BMP}
    \caption{$\phi = 180^{\circ}$}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/270_noise.BMP}
    \caption{$\phi = 270^{\circ}$}
\end{subfigure}
\caption{Aufgezeichnete Spannungsverläufe für das verrauschte Signal.}
\end{figure}
In \autoref{fig:unverrauscht} sind die mit dem Oszilloskop aufgezeichneten Spannungsverläufe des unverrauschten Signals bei verschiedenen Phasenverschiebungen $\phi$ dargestellt, in \autoref{fig:verrauscht} die Spannungsverläufe des verrauschten Signales bei den selben Phasenverschiebungen. In \autoref{tab:messdaten} sind die am Tiefpass abgelesenen Spannungen bei verschiedenen $\phi$ aufgelistet. In \autoref{fig:tiefpass} sind diese Werte noch einmal graphisch dargestellt. Die Ausgleichskurven sind dabei Funktionen der Form
